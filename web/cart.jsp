                                            ...
                                            <tr class="cart_item pane">
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity buttons_added">
                                                        ...
                                                        <input type="number" size="4" class="input-text qty text quantity" title="Qty" name="${item.product.name}" id="${item.product.name}"  value="${item.quantity}"  min="1" max="${item.product.quantity}" >
